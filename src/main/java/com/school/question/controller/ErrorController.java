...
public class ErrorController {
	 ...
	 * exception(final Throwable throwable, final Model model) {
	 * logger.error("Exception during execution of SpringSecurity application",
	 * throwable); String errorMessage = (throwable != null ? throwable.getMessage()
	 * : "Unknown error"); model.addAttribute("errorMessage", errorMessage); return
	 * "error"; }
	 * 
	 */}
